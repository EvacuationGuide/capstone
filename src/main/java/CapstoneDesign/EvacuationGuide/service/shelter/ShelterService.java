...
public class ShelterService {
    ...
    public void findShelters(){
        ...
        List<Shelter> shelters = shelterRepository.findAll();
        for (Shelter shelter : shelters) {
             double distance = distanceInKilometerByHaversine(shelter.getLatitude(),
        ...
        for (Shelter findShelter : findShelters) {
            System.out.println("대피소 이름 = " + findShelter.getName());
            //System.out.println("직선거리 = " + findShelter.getName());
        }
    }
